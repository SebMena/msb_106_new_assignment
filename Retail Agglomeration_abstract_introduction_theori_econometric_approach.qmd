...
Larger malls gives the customer more options to choose from and are often placed close, but outside a CBD which might be more attractive for customers to visit, and then also explaining why customers could be more interested in traveling further to visit these malls instead of visiting a mall in a CBD or the CBD itself.
...
Looking at this in light of our findings related to Malls, the optimal location would be in a cluster close to a mall.
A brief look at our data from QGIS also shows that areas around the malls tends to have a small clusters of dentists.
This also support Marshall where sharing, learning and matching are 3 central factors.
Beeing located close to the competition could possibly:\

-   Makes it easer to recruit new employees with the needed level of skills and education.

-   Recruit new customers as you are more visible in areas where people are looking for dental services

-   Sharing customers, as mentioned - One dentist can refer a customer to a specialist close by.

    Another Mashiallian point to be made could be the advantage of industry clusters. Taken for granted that the data on Dentist includes both "normal Dentists" and specialist. Where in this case a "normal dentist" would for example recommend one of their customers to go see a specialist to get braces. The customer would then probably prefer to go to the closes specialist. The access to work force in these areas would also be good and will be within the same geographic area.

The fact that x_sum (population density) has a positive effect on income could indicate that it helps being located close to the market and the transportation cost should be reduced for the customer.
...
Nevertheless, some dentist seek closer to CBD areas and areas with more foot trafic to capture most of the remaining part of the population.
...
Also if a customer happen to loose its local dentist, it´s reason to believe that the customer are likely to choose a new dentist near by, hence the example presented earlier for advantages being located close to the competition.
